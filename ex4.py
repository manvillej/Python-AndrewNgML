...
def main():
    ...
    # Unroll parameters
    initialNNParams = np.append(
        initialTheta1.flatten(),
        initialTheta2.flatten())
    ...
    print('\nCost at parameters (loaded from ex4weights): {:.6f}'.format(
        debug_J))
